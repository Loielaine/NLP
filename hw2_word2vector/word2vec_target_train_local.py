...
def save_model(W1, W2):
	handle = open("saved_W1_target.data", "wb+")
	np.save(handle, W1, allow_pickle = False)
	handle.close()

	handle = open("saved_W2_target.data", "wb+")
...
if __name__ == '__main__':
	if len(sys.argv) == 1:
		...
		samplingTable = pickle.load(open("./load_data/w2v_cumulative_dict.p", "rb"))
		print('Sampling Table loaded...')
