...
def load_model():
	handle = open("saved_W1_target_cluster3.data", "rb")
	W1 = np.load(handle)
	handle.close()
	handle = open("saved_W2_target_cluster3.data", "rb")
	W2 = np.load(handle)
	handle.close()
	return [W1, W2]
...
if __name__ == '__main__':
	if len(sys.argv) == 1:
		...
		testoutput = '/home/liyixi/hw2/intrisic-output_cluster_target3.csv'
		...
		# print(get_similairy('fresh', 'fresh'))
