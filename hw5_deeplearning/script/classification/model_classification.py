...
if __name__ == "__main__":
	...
	parser.add_argument("--data_dir",
	                    default = '/Users/Loielaine/Desktop/umich-2020/SI630/hw/hw5/data/classification/',
	                    type = str)
	...
	parser.add_argument("--output_dir",
	                    default = '/Users/Loielaine/Desktop/umich-2020/SI630/hw/hw5/output/classification/',
	                    type = str,
	...
	#                             '--load_pretraining_model=/Users/Loielaine/Desktop/umich-2020/SI630/hw/hw5/output/fine-tuning/checkpoint-4500/',
	#                             '--do_train', '--do_eval'])
	# args = parser.parse_args(['--task_name=bert_classification', '--learning_rate=5e-5',
	#                            '--do_train', '--do_eval'])
	# # Step 2 args
	...
	if args.do_train and args.do_eval:
		...
		if args.load_pretraining_model is not None:
			# Set tokenizer
			tokenizer = BertTokenizer.from_pretrained(args.load_pretraining_model, do_lower_case = True)
			# tokenizer = BertTokenizer.from_pretrained('bert-base-uncased', do_lower_case = True)
			# Set model
			model = BertForSequenceClassification.from_pretrained(args.load_pretraining_model, num_labels = 2,
	...
	if args.do_test:
		...
		if args.load_model_name is not None:
			# Set tokenizer
			tokenizer = BertTokenizer.from_pretrained(args.load_model_name, do_lower_case = True)
			# Set model
			model = BertForSequenceClassification.from_pretrained(args.load_model_name, num_labels = 2)
			model.to(device)
